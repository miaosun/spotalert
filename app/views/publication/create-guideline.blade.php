            ...
            <div class="tab-pane fade in active" id="alert_english">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        echo Form::textarea('guideline-description');}}
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        echo Form::select('guideline-countries[]', $country_options, null,  array('class' => 'chosen-select', 'multiple', 'data-placeholder' => 'Pick at least one country'))}}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        echo Form::select('guideline-types[]', $event_type_options, null,  array('class' => 'chosen-select', 'multiple', 'data-placeholder' => 'Pick at least one type of event'))}}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="inrow">
                            ...
                            echo Form::radio('guideline-visibility', 1, false);
                            echo Form::label('alert-radiohidden-label', 'Hidden');
                            echo Form::radio('guideline-visibility', 0, true);}}
                        </div>
                    </div>

                    <div class="form-group">
                        {{ Form::label('alert-guidelines-label', 'Associate alerts');
                        echo Form::select('guideline-alerts[]', $alert_options, null,  array('class' => 'chosen-select', 'multiple', 'data-placeholder' => 'Pick at least one alert'))}}
                    </div>
                </div>
                @if($errors->has())
